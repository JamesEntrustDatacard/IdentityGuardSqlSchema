...
-- This file defines the database schema used by Entrust IdentityGuard 12.0
  ...
  (
    ...
    smartcredentialblobs blob DEFAULT NULL,
  ...
  (
    ...
    CONSTRAINT cards_pkey PRIMARY KEY (serial_number) NOT DEFERRABLE,
  ...
  (
    ...
    CONSTRAINT alias_pkey PRIMARY KEY (group_id, alias) NOT DEFERRABLE,
  ...
  CREATE TABLE audits
  (
     audit_seqno      DECIMAL(19,0) PRIMARY KEY,
